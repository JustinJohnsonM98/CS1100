...
{
    public static void main(String [] args){//entry point Rectangle()
    //constructor
    ...
    //window print:
    double hDoor = 1.75; //initialize height of door
    double wDoor = .95; // initialize width of door
    ...
    //step 6 below:
        ...
        System.out.printf("%nThe surface area minus doors and windows is %.2f", 
surSub); //print
        ...
        System.out.printf("Rectangle y coordinate: " + myRec.getY() + "%n"); 
//print y
        System.out.printf("Rectangle width:  " + myRec.getWidth() + "%n"); //print w
        System.out.printf("Rectangle height: " + myRec.getHeight() + "%n"); //printh
        //step 22 below
...
//print y
        ...
        System.out.printf("%n%nRectangle x coordinate: " + myRec.getX() + "%n"); //
